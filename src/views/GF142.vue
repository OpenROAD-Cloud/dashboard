...
export default {
  ...
  methods: {
    ...
    loadMetrics() {
      ...
      var swervMetrics = db.collection("metrics2").doc("gf14-swerv");
      ...
      var tinyRocketMetrics = db.collection("metrics2").doc("gf14-tinyrocket");
      ...
      var aesMetrics = db.collection("metrics2").doc("gf14-aes");
      ...
      var bpfetopMetrics = db.collection("metrics2").doc("gf14-bpfetop");
      ...
      var dnodeMetrics = db.collection("metrics2").doc("gf14-dnode");
      ...
      var ibexMetrics = db.collection("metrics2").doc("gf14-ibex");
