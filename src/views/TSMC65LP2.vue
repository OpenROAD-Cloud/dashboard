...
export default {
  ...
  methods: {
    ...
    loadMetrics() {
      ...
      var tinyRocketMetrics = db.collection("metrics2").doc("tsmc65lp-tinyrocket");
      ...
      var bp_feMetrics = db.collection("metrics2").doc("tsmc65lp-bpfe");
      ...
      var bp_singleMetrics = db.collection("metrics2").doc("tsmc65lp-bpsingle");
